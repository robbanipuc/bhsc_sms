...
<table class="upper_table">
    ...
    <table class="result_table">
        ...
        <td>'.bfn(isset($t['bangla1 total']) ? $t['bangla1 total'] : 0).'</td><td>'.bfn(isset($t['bangla2 total']) ? $t['bangla2 total'] : 0).'</td><td>'.bfn((isset($t['bangla1 total']) ? $t['bangla1 total'] : 0) + (isset($t['bangla2 total']) ? $t['bangla2 total'] : 0)).'</td><td>'.bfn(isset($t['bangla avg']) ? $t['bangla avg'] : 0).'</td><td>'.bfn(number_format(isset($t['bangla gp']) ? $t['bangla gp'] : 0, 2)).'</td><td style="color:'.redmark(isset($t['bangla lg']) ? $t['bangla lg'] : '').';">'.lg_bangla(isset($t['bangla lg']) ? $t['bangla lg'] : '').'</td>
        ...
        <td>'.bfn(isset($t['english1']) ? $t['english1'] : 0).'</td>
        <td>'.bfn(isset($t['english2']) ? $t['english2'] : 0).'</td>
        <td>'.bfn((isset($t['english1']) ? $t['english1'] : 0) + (isset($t['english2']) ? $t['english2'] : 0)).'</td>
        <td>'.bfn(isset($t['english avg']) ? $t['english avg'] : 0).'</td>
        <td>'.bfn(number_format(isset($t['english gp']) ? $t['english gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t['english lg']) ? $t['english lg'] : '').';">'.lg_bangla(isset($t['english lg']) ? $t['english lg'] : '').'</td>
        ...
        <td colspan="4">'.bfn(isset($t['ict total']) ? $t['ict total'] : 0).'</td>
        <td>'.bfn(number_format(isset($t['ict gp']) ? $t['ict gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t['ict lg']) ? $t['ict lg'] : '').';">'.lg_bangla(isset($t['ict lg']) ? $t['ict lg'] : '').'</td>
        </tr>
        ...
        <td>'.bfn(isset($t[$subject1.'1 total']) ? $t[$subject1.'1 total'] : 0).'</td>
        <td>'.bfn(isset($t[$subject1.'2 total']) ? $t[$subject1.'2 total'] : 0).'</td>
        <td>'.bfn(
            (isset($t[$subject1.'1 total']) ? $t[$subject1.'1 total'] : 0) +
            (isset($t[$subject1.'2 total']) ? $t[$subject1.'2 total'] : 0)
        ).'</td>
        <td>'.bfn(isset($t[$subject1.' avg']) ? $t[$subject1.' avg'] : 0).'</td>
        <td>'.bfn(number_format(isset($t[$subject1.' gp']) ? $t[$subject1.' gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t[$subject1.' lg']) ? $t[$subject1.' lg'] : '').';">'.
            lg_bangla(isset($t[$subject1.' lg']) ? $t[$subject1.' lg'] : '').
        '</td>
       ...
       <td>'.bfn(isset($t[$subject2.'1 total']) ? $t[$subject2.'1 total'] : 0).'</td>
        <td>'.bfn(isset($t[$subject2.'2 total']) ? $t[$subject2.'2 total'] : 0).'</td>
        <td>'.bfn(
            (isset($t[$subject2.'1 total']) ? $t[$subject2.'1 total'] : 0) +
            (isset($t[$subject2.'2 total']) ? $t[$subject2.'2 total'] : 0)
        ).'</td>
        <td>'.bfn(isset($t[$subject2.' avg']) ? $t[$subject2.' avg'] : 0).'</td>
        <td>'.bfn(number_format(isset($t[$subject2.' gp']) ? $t[$subject2.' gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t[$subject2.' lg']) ? $t[$subject2.' lg'] : '').';">'.
            lg_bangla(isset($t[$subject2.' lg']) ? $t[$subject2.' lg'] : '').
        '</td>
        ...
        <td>'.bfn(isset($t[$subject3.'1 total']) ? $t[$subject3.'1 total'] : 0).'</td>
        <td>'.bfn(isset($t[$subject3.'2 total']) ? $t[$subject3.'2 total'] : 0).'</td>
        <td>'.bfn(
            (isset($t[$subject3.'1 total']) ? $t[$subject3.'1 total'] : 0) +
            (isset($t[$subject3.'2 total']) ? $t[$subject3.'2 total'] : 0)
        ).'</td>
        <td>'.bfn(isset($t[$subject3.' avg']) ? $t[$subject3.' avg'] : 0).'</td>
        <td>'.bfn(number_format(isset($t[$subject3.' gp']) ? $t[$subject3.' gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t[$subject3.' lg']) ? $t[$subject3.' lg'] : '').';">'.
            lg_bangla(isset($t[$subject3.' lg']) ? $t[$subject3.' lg'] : '').
        '</td>
        ...
        <td>'.bfn(isset($t[$fourth_sub.'1 total']) ? $t[$fourth_sub.'1 total'] : 0).'</td>
        <td>'.bfn(isset($t[$fourth_sub.'2 total']) ? $t[$fourth_sub.'2 total'] : 0).'</td>
        <td>'.bfn(
            (isset($t[$fourth_sub.'1 total']) ? $t[$fourth_sub.'1 total'] : 0) +
            (isset($t[$fourth_sub.'2 total']) ? $t[$fourth_sub.'2 total'] : 0)
        ).'</td>
        <td>'.bfn(isset($t[$fourth_sub.' avg']) ? $t[$fourth_sub.' avg'] : 0).'</td>
        <td>'.bfn(number_format(isset($t[$fourth_sub.' gp']) ? $t[$fourth_sub.' gp'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t[$fourth_sub.' lg']) ? $t[$fourth_sub.' lg'] : '').';">'.
            lg_bangla(isset($t[$fourth_sub.' lg']) ? $t[$fourth_sub.' lg'] : '').
        '</td>
        ...
        <td colspan="4">জিপিএ</td>
        <td>'.bfn(number_format(isset($t['gpa']) ? $t['gpa'] : 0, 2)).'</td>
        <td style="color:'.redmark(isset($t['grade']) ? $t['grade'] : '').';">'.
            lg_bangla(isset($t['grade']) ? $t['grade'] : '').
        '</td>

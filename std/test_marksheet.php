...
'; 
        ...
        $data.='
        <tr>
        <td>'.bfn($student_id).'</td><td>'.bfn($table_content[$subject.$part.' crtv']).'</td><td>'.bfn($table_content[$subject.$part.' mcq']).'</td><td></td><td>'.bfn($table_content[$subject.$part.' total']).'</td><td>'.bfn(number_format($table_content[$subject.' gp'],2)).'</td><td style="color:'.redmark($table_content[$subject.' lg']).';">'.lg_bangla($table_content[$subject.' lg']).'</td><td> </td>
        </tr>
'; 
    }
}

...
<table class="result_table">
  <thead>
    ...
    <tr>
        <td>গড় <br>নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড়<br> নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড় <br>নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড় <br>নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড় <br>নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড়<br> নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td><td>গড় <br>নম্বর</td><td>গ্রেড <br> পয়েন্ট</td><td>লেটার <br> গ্রেড</td>
    </tr>
    </thead>
...
$data.='
<tr>
    <td>'.bfn($table_content['Student ID']).'</td><td>'.$table_content['name_bangla'].'</td><td>'.bfn($table_content['bangla avg']).'</td><td>'.bfn(number_format($table_content['bangla gp'],2)).'</td><td>'.lg_bangla($table_content['bangla lg']).'</td><td>'.bfn($table_content['english avg']).'</td><td>'.bfn(number_format($table_content['english gp'],2)).'</td><td>'.lg_bangla($table_content['english lg']).'</td><td>'.bfn($table_content['ict total']).'</td><td>'.bfn(number_format($table_content['ict gp'],2)).'</td><td>'.lg_bangla($table_content['ict lg']).'</td><td>'.bfn($table_content['physics avg']).'</td><td>'.bfn(number_format($table_content['physics gp'],2)).'</td><td>'.lg_bangla($table_content['physics lg']).'</td><td>'.bfn($table_content['chemistry avg']).'</td><td>'.bfn(number_format($table_content['chemistry gp'],2)).'</td><td>'.lg_bangla($table_content['chemistry lg']).'</td><td>'.bfn($table_content['biology avg']).'</td><td>'.bfn(number_format($table_content['biology gp'],2)).'</td><td>'.lg_bangla($table_content['biology lg']).'</td><td>'.bfn($table_content['math avg']).'</td><td>'.bfn(number_format($table_content['math gp'],2)).'</td><td>'.lg_bangla($table_content['math lg']).'</td><td>'.subject_name_bangla($table_content['fourth_sub']).'</td><td>'.bfn(number_format($table_content['gpa without 4th'],2)).'</td><td>'.bfn($table_content['point_from_4th']).'</td><td>'.bfn(number_format($table_content['gpa'],2)).'</td><td>'.lg_bangla($table_content['grade']).
'</td></tr>
' ;
endwhile;  
...
';
    ...
    $data.='
    <tr>
        <td>'.bfn($table_content['Student ID']).'</td><td>'.$table_content['name_bangla'].'</td><td>'.bfn($table_content['bangla avg']).'</td><td>'.bfn(number_format($table_content['bangla gp'],2)).'</td><td>'.lg_bangla($table_content['bangla lg']).'</td><td>'.bfn($table_content['english avg']).'</td><td>'.bfn(number_format($table_content['english gp'],2)).'</td><td>'.lg_bangla($table_content['english lg']).'</td><td>'.bfn($table_content['ict total']).'</td><td>'.bfn(number_format($table_content['ict gp'],2)).'</td><td>'.lg_bangla($table_content['ict lg']).'</td><td>'.bfn($table_content['accounting avg']).'</td><td>'.bfn(number_format($table_content['accounting gp'],2)).'</td><td>'.lg_bangla($table_content['accounting lg']).'</td><td>'.bfn($table_content['business_organization avg']).'</td><td>'.bfn(number_format($table_content['business_organization gp'],2)).'</td><td>'.lg_bangla($table_content['business_organization lg']).'</td><td>'.bfn($table_content['production_management avg']).'</td><td>'.bfn(number_format($table_content['production_management gp'],2)).'</td><td>'.lg_bangla($table_content['production_management lg']).'</td><td>'.bfn($table_content['economics avg']).'</td><td>'.bfn(number_format($table_content['economics gp'],2)).'</td><td>'.lg_bangla($table_content['economics lg']).'</td><td>'.subject_name_bangla($table_content['fourth_sub']).'</td><td>'.bfn(number_format($table_content['gpa without 4th'],2)).'</td><td>'.bfn($table_content['point_from_4th']).'</td><td>'.bfn(number_format($table_content['gpa'],2)).'</td><td>'.lg_bangla($table_content['grade']).
    '</td></tr>
    ' ;
    endwhile;  
    ...
    $data.='
    <tr>
        <td>'.bfn($table_content['Student ID']).'</td><td>'.$table_content['name_bangla'].'</td><td>'.bfn($table_content['bangla avg']).'</td><td>'.bfn(number_format($table_content['bangla gp'],2)).'</td><td>'.lg_bangla($table_content['bangla lg']).'</td><td>'.bfn($table_content['english avg']).'</td><td>'.bfn(number_format($table_content['english gp'],2)).'</td><td>'.lg_bangla($table_content['english lg']).'</td><td>'.bfn($table_content['ict total']).'</td><td>'.bfn(number_format($table_content['ict gp'],2)).'</td><td>'.lg_bangla($table_content['ict lg']).'</td><td>'.bfn($table_content['civics avg']).'</td><td>'.bfn(number_format($table_content['civics gp'],2)).'</td><td>'.lg_bangla($table_content['civics lg']).'</td><td>'.bfn($table_content['logic avg']).'</td><td>'.bfn(number_format($table_content['logic gp'],2)).'</td><td>'.lg_bangla($table_content['logic lg']).'</td><td>'.bfn($table_content['sociology avg']).'</td><td>'.bfn(number_format($table_content['sociology gp'],2)).'</td><td>'.lg_bangla($table_content['sociology lg']).'</td><td>'.bfn($table_content['islamic_history avg']).'</td><td>'.bfn(number_format($table_content['islamic_history gp'],2)).'</td><td>'.lg_bangla($table_content['islamic_history lg']).'</td><td>'.bfn($table_content['economics avg']).'</td><td>'.bfn(number_format($table_content['economics gp'],2)).'</td><td>'.lg_bangla($table_content['economics lg']).'</td><td>'.subject_name_bangla($table_content['fourth_sub']).'</td><td>'.bfn(number_format($table_content['gpa without 4th'],2)).'</td><td>'.bfn($table_content['point_from_4th']).'</td><td>'.bfn(number_format($table_content['gpa'],2)).'</td><td>'.lg_bangla($table_content['grade']).
    '</td></tr>
    ' ;
    endwhile;  
